...
public class SalesManagementSystemApplication {
	...
	CommandLineRunner run(OrderServiceImpl orderService, ProductServiceImpl productService,
		...
		return args -> {
			...
			File productsFile = new File(
					Objects.requireNonNull(classLoader.getResource("data/products.json")).getFile());
           ...
           Set<Role> roles = new HashSet<>();
			...
			File orderItemTwoFile = new File(
					Objects.requireNonNull(classLoader.getResource("data/orderItemTwo.json")).getFile());
			...
			File orderItemThreeFile = new File(
					Objects.requireNonNull(classLoader.getResource("data/orderItemThree.json")).getFile());
			...
			File orderItemFourFile = new File(
					Objects.requireNonNull(classLoader.getResource("data/orderItemFour.json")).getFile());
